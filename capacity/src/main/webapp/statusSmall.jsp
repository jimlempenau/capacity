...
<%@page import="com.resc.StatusCounter"%>
	<div id="italicFont">Current Capacity from Gov. Murphy: <%=StatusCounter.getMaxCapacity() %></div>
  	...
  	<%} %>
  	<tr><th>Walk Up </th><td><%=PeopleCounter.getWalkInEntered() %></td><td><%=PeopleCounter.getWalkInLeft()%></td><td><%=PeopleCounter.getWalkInOnGrounds() %></td><td><%=PeopleCounter.howManyWalkInsRemaining()%></td>  
	</tr>
